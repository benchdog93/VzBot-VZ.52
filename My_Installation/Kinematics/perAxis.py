...
#   C:\python-3.10.0\scripts\perAxis.py
#
# * in SuperSlicer, add the following entry to: Print Settings > Output Options > Post Processing Scripts:
#   C:\python-3.10.0\python.exe C:\python-3.10.0\scripts\perAxis.py
#   path to python.exe and the perAxis.py script depends on where you put them both.
#
...
# ; 
# ; ACCEL: 4000/2000/500     for First Layer
# ; ACCEL: 10000/5000/500    for Travel
# ; ACCEL: 2000/1000/500     for TYPE:External perimeter
# ; ACCEL: 2000/1000/500     for TYPE:Overhang perimeter
# ; ACCEL: 2500/1750/500     for TYPE:Internal perimeter
# ; ACCEL: 2500/1750/500     for TYPE:Top solid infill
# ; ACCEL: 4000/2000/500     for TYPE:Solid infill
# ; ACCEL: 6000/3000/500     for TYPE:Internal infill
# ; ACCEL: 5000/2500/500     for TYPE:Bridge infill
# ; ACCEL: 4000/2000/500     for TYPE:Internal bridge infill
# ; ACCEL: 4000/2000/500     for TYPE:Thin wall
# ; ACCEL: 2000/1000/500     for TYPE:Gap fill
# ; ACCEL: 4000/2000/500     for TYPE:Skirt
# ; ACCEL: 6000/3000/500     for TYPE:Support material
# ; ACCEL: 6000/3000/500     for TYPE:Support material interface
# ;
#
...
# 
# @author kdb424
# @original_author VintageGriffin
# @version 2.0
#
import sys, re, time
...
gcode_accel_features = {
    'First Layer': 'SET_KINEMATICS_LIMIT X_ACCEL=2000 Y_ACCEL=1000 Z_ACCEL=500',
    'Travel'     : 'SET_KINEMATICS_LIMIT X_ACCEL=4000 Y_ACCEL=2000 Z_ACCEL=500'
}
...
setting_regex = re.compile(r'\s*;\s*ACCEL\s*:\s*(?P<x_accel>\d+)\s*[/\\]\s*(?P<y_accel>\d+)\s*[/\\]\s*(?P<z_accel>\d+)\s+for\s+(?P<type>.+)')
with open(sys.argv[1], 'r') as gcode:
    for line in gcode:
        curr_file_line += 1
        setting = setting_regex.match(line)
        if setting:
            accel_gcode  = 'SET_KINEMATICS_LIMIT X_ACCEL=' + setting.group('x_accel') + ' Y_ACCEL=' + setting.group('y_accel') + ' Z_ACCEL=' + setting.group('z_accel')
    ...
    for line in output:
        ...
        if curr_output_line == settings_end_at_line:  # append some debug information
            ...
            for type, gcode in gcode_accel_features.items():
                f.write(';  ' + type.ljust(35) + gcode.replace('SET_KINEMATICS_LIMIT ', '') + "\n")
